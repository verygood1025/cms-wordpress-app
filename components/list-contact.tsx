...
export default function ListContact({ username, contactLink, socialLink }) {
    ...
    return (
        <>
        <ul className="list-contact flex flex-wrap justify-center items-center list-none">
            {phoneNumber && 
            <li className="phone">
            ...
            <li className="sms">
                <Popup trigger={
                <Link href='#' title="Zalo" className="poppup-link" rel="nofollow">
            ...
            <li className="ngan-hang">
                <Popup trigger={
                <Link href='#' title="Ngân Hàng" className="poppup-link" rel="nofollow">
            ...
            <li className="momo">
                <Popup trigger={
                <Link href='#' title="Momo" className="poppup-link" rel="nofollow">
            ...
            <li className="share">
                <Popup trigger={
                <Link href='#' title="Chia Sẻ Bio" className="poppup-link" rel="nofollow">
